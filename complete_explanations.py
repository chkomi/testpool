...
def create_complete_explanations():
    """해설.txt 파일을 바탕으로 모든 과목에 대한 완전한 상세한 해설을 생성합니다."""
...
def update_exam_file_with_complete_explanations():
    """2025-exam.js 파일에 완전한 상세한 해설을 추가합니다."""
    
    # 완전한 상세한 해설 데이터 생성
    complete_explanations = create_complete_explanations()
    ...
    # 각 과목별로 상세한 해설 추가
    for subject, questions in complete_explanations.items():
    ...
    print("완전한 상세한 해설이 성공적으로 추가되었습니다!")

if __name__ == "__main__":
    update_exam_file_with_complete_explanations() 