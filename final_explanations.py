...
def create_final_explanations():
    """해설.txt 파일을 바탕으로 모든 과목에 대한 최종 완전한 상세한 해설을 생성합니다."""
    ...
    final_explanations = {
        "농어촌정비법": {
            ...
            9: {
                ...
                "detailed_explanation": "농업생산기반시설이나 용수를 사용허가를 받아 사용하는 경우에는 사용료를 징수할 수 있으며, 무단으로 점용하는 경우에는 무단점용료를 징수할 수 있습니다. 이는 시설의 유지보수와 효율적인 관리를 위한 제도로, 공정한 사용료 부과를 통해 시설의 지속가능성을 확보합니다.",
                "url1": "https://www.law.go.kr/법령/농어촌정비법 시행령/(20250807,35696,20250805)/제32조",
                "url2": "https://www.law.go.kr/법령/농어촌정비법 시행령/(20250807,35696,20250805)/제94조"
            },
            10: {
                "explanation": "농어촌정비법 제6조(농업생산기반 정비사업의 원칙)",
                "detailed_explanation": "농업생산기반 정비사업은 농업생산성의 향상과 농어촌의 발전을 도모하기 위하여 계획적으로 시행되어야 하며, 농업생산기반시설의 효율적인 관리와 보전을 위하여 필요한 조치를 강구해야 합니다. 이는 농업의 지속가능한 발전과 농어촌의 경쟁력 향상을 위한 기본 원칙입니다.",
                "url": "https://www.law.go.kr/법령/농어촌정비법/(20250621,20581,20241220)/제6조"
            },
            11: {
                "explanation": "농어촌정비법 제5조(농어촌 정비를 위한 자원 조사)",
                "detailed_explanation": "농어촌 정비를 위한 자원 조사는 농지의 분포상태와 이용에 관한 사항, 농업생산 기반 정비에 관한 사항, 농어촌 관광휴양자원에 관한 사항 등을 포함합니다. 이는 농어촌의 체계적인 정비와 발전을 위한 기초 자료로 활용됩니다.",
                "url": "https://www.law.go.kr/법령/농어촌정비법/(20250621,20581,20241220)/제5조"
            },
            12: {
                "explanation": "농어촌정비법 제7조(농업생산기반 정비계획의 수립)",
                "detailed_explanation": "농업생산기반 정비계획에는 농업생산기반시설의 설치 및 관리에 관한 계획, 농지의 정비 및 개발에 관한 계획, 농업용수의 개발 및 관리에 관한 계획 등이 포함되어야 합니다. 이는 농업생산기반의 체계적인 정비와 확충을 위한 종합적인 계획입니다.",
                "url": "https://www.law.go.kr/법령/농어촌정비법/(20250621,20581,20241220)/제7조"
            },
            13: {
                "explanation": "농어촌정비법 제15조(매립지 등의 관리·처분계획)",
                "detailed_explanation": "매립지 등의 관리·처분계획에 따라 매립지 등 중 농지를 임대하려면 지방자치단체, 한국농어촌공사, 해당 매립지 등 조성사업 시행으로 피해를 입은 농업인으로 구성된 영농조합법인과 농업회사법인에게 임대해야 합니다. 이는 농지의 효율적인 이용과 농업인의 권익 보호를 위한 제도입니다.",
                "url": "https://www.law.go.kr/법령/농어촌정비법/(20250621,20581,20241220)/제15조"
            },
            14: {
                "explanation": "농어촌정비법 제22조(농업생산기반시설의 등록)",
                "detailed_explanation": "농업생산기반시설 중 저수지, 배수문, 취입보, 양수장, 관개수로, 배수로, 농로 등은 시장·군수·구청장에게 등록해야 합니다. 이는 농업생산기반시설의 체계적인 관리와 효율적인 운영을 위한 제도입니다.",
                "url": "https://www.law.go.kr/법령/농어촌정비법/(20250621,20581,20241220)/제22조"
            },
            15: {
                "explanation": "농어촌정비법 시행령 제50조(생활환경정비계획의 고시)",
                "detailed_explanation": "생활환경정비계획의 고시에는 생활환경정비사업의 목적, 기본방향, 농어촌마을의 건설·재개발·정비, 생활환경기반시설의 정비·확충 등 주요사업계획의 개요가 포함됩니다. 사업비는 고시 대상에서 제외되며, 이는 투명한 사업 추진을 위한 제도입니다.",
                "url": "https://www.law.go.kr/법령/농어촌정비법 시행령/(20250807,35696,20250805)/제50조"
            },
            16: {
                "explanation": "농어촌정비법 제55조(생활환경정비계획의 내용)",
                "detailed_explanation": "생활환경정비계획에는 치산녹화 등 국토보전시설의 정비·확충 사업, 도로, 상·하수도, 오·폐수처리시설 등 생활환경기반시설의 정비·확충 사업, 농어촌 용수 및 배수 시설의 정비·개발 사업, 수질오염 방지를 위한 사업 등이 포함됩니다.",
                "url": "https://www.law.go.kr/법령/농어촌정비법/(20250621,20581,20241220)/제55조"
            },
            17: {
                "explanation": "농어촌정비법 시행령 제66조(기획기술지원단의 구성과 운영)",
                "detailed_explanation": "기획기술지원단은 농림축산식품부에 두며, 기획기술지원단장은 농림축산식품부의 3급 공무원 또는 고위공무원단에 속하는 일반직공무원 중에서 농림축산식품부장관이 임명합니다. 농림축산식품부장관은 설계 및 집행상의 기술지원을 한국농어촌공사 소속 연구기관이나 농어촌지역개발 관련 연구기관에 의뢰할 수 있습니다.",
                "url": "https://www.law.go.kr/법령/농어촌정비법 시행령/(20250807,35696,20250805)/제66조"
            },
            18: {
                "explanation": "농어촌정비법 제72조(농어촌산업 육성 지원기구)",
                "detailed_explanation": "농어촌산업 육성 지원기구는 농어촌산업 육성정책 및 관련 계획에 관한 조사·연구, 평가, 컨설팅 등의 업무를 지원할 수 있는 전문 인력을 보유하고 있어야 하며, 농어촌산업 육성 업무를 수행하기 위한 전담부서를 갖추고 있어야 합니다.",
                "url": "https://www.law.go.kr/법령/농어촌정비법/(20250621,20581,20241220)/제72조"
            },
            19: {
                "explanation": "농어촌정비법 제73조(농어촌산업 육성 관련 평가)",
                "detailed_explanation": "농어촌산업 육성 관련 평가의 기준에는 농어촌산업 육성 기본계획 및 시행계획 수립의 타당성, 목표의 달성도 및 성과, 집행과정의 효율성이 포함됩니다. 자금의 조달성은 평가 기준에서 제외되며, 이는 사업의 실질적인 성과와 효율성에 집중하기 위한 것입니다.",
                "url": "https://www.law.go.kr/법령/농어촌정비법/(20250621,20581,20241220)/제73조"
            },
            20: {
                "explanation": "농어촌정비법 제130조(벌칙)",
                "detailed_explanation": "농어촌정비법 제130조에 따른 벌칙은 조성용지를 전매한 자, 농업생산기반시설관리자의 허락 없이 수문을 조작하거나 용수를 인수함으로써 농어촌용수의 이용·관리에 지장을 준 자, 사업정지명령을 받고도 그 기간 중에 사업을 하거나 사업장 폐쇄명령을 받고도 계속하여 사업을 한 자, 농업생산기반시설을 불법으로 점용하거나 사용한 자에 대해 적용됩니다.",
        ...
        "행동강령": {
            ...
            2: {
                ...
                "url": "https://www.law.go.kr/법령/한국농어촌공사 임직원 행동강령/(9999,20241231)/제38조"
            },
            3: {
                ...
                "url": "https://www.law.go.kr/법령/한국농어촌공사 임직원 행동강령/(9999,20241231)/제25조"
            }
        },
        "회계기준": {
            1: {
...
def update_exam_file_with_final_explanations():
    """2025-exam.js 파일에 최종 완전한 상세한 해설을 추가합니다."""
    
    # 최종 완전한 상세한 해설 데이터 생성
    final_explanations = create_final_explanations()
    ...
    # 각 과목별로 상세한 해설 추가
    for subject, questions in final_explanations.items():
    ...
    print("최종 완전한 상세한 해설이 성공적으로 추가되었습니다!")

if __name__ == "__main__":
    update_exam_file_with_final_explanations() 