...
def create_comprehensive_explanations():
    ...
    return comprehensive_explanations

def update_exam_file_with_comprehensive_explanations():
    """2025-exam.js 파일에 포괄적인 상세한 해설을 추가합니다."""
    
    # 포괄적인 상세한 해설 데이터 생성
    comprehensive_explanations = create_comprehensive_explanations()
    ...
    # 각 과목별로 상세한 해설 추가
    for subject, questions in comprehensive_explanations.items():
    ...
    print("포괄적인 상세한 해설이 성공적으로 추가되었습니다!")

if __name__ == "__main__":
    update_exam_file_with_comprehensive_explanations() 